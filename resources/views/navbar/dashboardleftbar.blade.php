    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <nav id="sidebar">
            <ul class="list-unstyled components mb-5">
                <li><a href="{{ route('course.bcdrcoursepage') }}"><span class="nav-link"></span>Admin Management</a></li>
                <li><a href="{{ route('manage-quiz') }}"><span class="nav-link"></span>Manage Quiz</a></li>
            </ul>
        </nav>
        @else
